...
Route::get('dao-tao/{alias}', 'IndexController@daoTaoDetail');
Route::get('chuyen-giao','IndexController@congNghe');
Route::get('chuyen-giao/{alias}.html','IndexController@congNgheDetail');
